...
# after -i (output side) - verified against go2rtc 1.9.10 (Frigate 0.17) and
# 1.9.14 (Frigate 0.18). A go2rtc that placed them input-side would make
# ffmpeg exit and kill the variants, so refuse to build on an unverified
# go2rtc version until it is re-checked (see README "Live bitrate
# enforcement") and added here.
